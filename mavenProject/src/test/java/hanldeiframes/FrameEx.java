...
public class FrameEx {
	public static void main(String[] args) {
		...
		// handle iframe // 4 diffnt ways to handle iFrames
		...
		driver.findElement(By.xpath("//body[@id='tinymce']")).clear(); // Input
		driver.findElement(By.xpath("//body[@id='tinymce']")).sendKeys("Hanle Iframe input ::");

		// Method3 - iframe using any property // webelement

		WebElement inputEle = driver.findElement(By.xpath("//iframe[@class='tox-edit-area__iframe']"));
		driver.switchTo().frame(inputEle);

		// Input driver.findElement(By.xpath("//body[@id='tinymce']")).clear();
